...
namespace Tesseract.Controls
{
	public class Window: MouseStateControl
	{
		...
		public Window()
		{
            ...
            backendWindow.Render += delegate(object sender, RenderEventArgs e) { OnRender(e); };
            backendWindow.Resize += delegate { base.Path = new Rectangle(backendWindow.W, backendWindow.H); };
            backendWindow.MouseMove += delegate(object sender, MouseEventArgs e)
			{
			...
			backendWindow.MousePress += delegate(object sender, MouseEventArgs e)
			{
				if (mouseOverControl != null)
				{
			...
			backendWindow.MouseRelease += delegate(object sender, MouseEventArgs e)
			{
