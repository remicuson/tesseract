...
namespace NDesk.Glitz
{
	public class Surface : IDisposable
	{
		...
		public Drawable Drawable {
			get {
				return Drawable.Lookup (GlitzAPI.glitz_surface_get_drawable (Handle), false);
			}
		}

		public Drawable AttachedDrawable {
			get {
				return Drawable.Lookup (GlitzAPI.glitz_surface_get_attached_drawable (Handle), false);
			}
		}
		...
		*/
		...
		protected virtual void Dispose (bool disposing)
		{
			...
			//Console.Error.WriteLine ("glitz_surface_destroy");
