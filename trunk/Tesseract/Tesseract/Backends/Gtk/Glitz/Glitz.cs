...
namespace NDesk.Glitz
{
	...
	//name mangled because "2D" starts with a digit
	public
	enum TextureTarget
	{
		Target2D,
	...
	public class GlitzAPI
	{
		...
		[DllImport("glitz")]
		public
		static extern void glitz_texture_object_set_filter (IntPtr texture, TextureFilterType type, TextureFilter filter);

		[DllImport("glitz")]
		public
		static extern TextureTarget glitz_texture_object_get_target (IntPtr texture);
